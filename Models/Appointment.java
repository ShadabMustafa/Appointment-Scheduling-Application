...
public class Appointment extends Record implements Model<Appointment> {
    ...
    /**
     * Appointment object
     * @param id appt id, used for ordering
     ...
     * @param  customerId, appt customerId, used for ordering/organization purposes
     * @param  userId, appt userId,  used for ordering/organization purposes
     * @param  contactId, appt contactId used for ordering/organization purposes
     */
     ...
     * @see Model#toValues()
     * duplicates fields from one instance of the record to this one
     * @return another instance of class.
     */
    @Override
     ...
     *
     * @param date either the start or end date and time
     * @param name the name of the field
     * @throws ValidationError an error stating the value is out of range
     */
    ...
    /**
     * Reports appointment string
     *@return a Appt string that can be shown in the report
     */
    public String toReportApptString() {
