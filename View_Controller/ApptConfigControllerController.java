...
/**
 * Appointment form configuration class.
  * @author Shadab Mustafa
 */

public class ApptConfigControllerController extends ConfigController<Appointment> {
    ...
    /**
     * establishes the date and time fields from the ZonedDateTime object
     *
    ...
    public ApptConfigControllerController(String windowTitle,
    ...
    protected String getResourceURL() {
        return "/View_Controller/ApptConfig.fxml";
    }
    ...
    /**
     * lambda: absorbs an exception and result set and also helps with resource cleanup
     * <p>
     * Makes a map of User Id to User object for easy indexing and searching
     */
    private void buildUserMap() {
        executeQuery("SELECT User_ID, User_Name FROM users", (exception, resultSet) -> {
    ...
    /**
     * filters a LocalDateTime out of the fields that make up the date/time info
     *
     * @param datePicker     a date picker for the date
     * @param hourPicker     a ComboBox for the hour
     * @param minutePicker   a ComboBox for the minute
